...
module.exports ={
	...
	insert: function(user, callback){
		...
		db.execute(sql, ['', employee.name, employee.username, employee.password, employee.phone], function(status){
			if(status){
				callback(true);
			}else{
				callback(false);
	...
	update: function(user, callback){
		...
		db.execute(sql, [employee.name, employee.username, employee.password, employee.phone employee.id], function(status){
			if(status){
				callback(true);
			}else{
				callback(false);
